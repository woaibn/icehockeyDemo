...
public class Rink {
	...
	public Rink(int rinkId, String rinkName, String rinkLogo, int countryId,
			int cityId, String telephone, boolean indoor, boolean hasLocker,
			boolean hasCarpark, String trainingDegree, int scale,
			boolean hasLandTrainingRoom, double area, double iceArea,
			Date completionDate, Date beginUseDate, Date openTime,
			boolean allowedSlip, String email, String iceType, String address,
			int environmentalIndex, Date changeDate, String province,
			String remark) {
		super();
		this.rinkId = rinkId;
		this.rinkName = rinkName;
	...
	public String toString() {
		return "Rink [rinkId=" + rinkId + ", rinkName=" + rinkName
				+ ", rinkLogo=" + rinkLogo + ", countryId=" + countryId
				+ ", cityId=" + cityId + ", telephone=" + telephone
				+ ", indoor=" + indoor + ", hasLocker=" + hasLocker
				+ ", hasCarpark=" + hasCarpark + ", trainingDegree="
				+ trainingDegree + ", scale=" + scale
				+ ", hasLandTrainingRoom=" + hasLandTrainingRoom + ", area="
				+ area + ", iceArea=" + iceArea + ", completionDate="
				+ completionDate + ", beginUseDate=" + beginUseDate
				+ ", openTime=" + openTime + ", allowedSlip=" + allowedSlip
				+ ", email=" + email + ", iceType=" + iceType + ", address="
				+ address + ", environmentalIndex=" + environmentalIndex
				+ ", changeDate=" + changeDate + ", province=" + province
				+ ", remark=" + remark + "]";
	}
