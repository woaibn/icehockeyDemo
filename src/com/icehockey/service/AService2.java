...
public class AService2 {
	...
	public boolean insertNewUser(String gender, double height, double weight, String roleName, String handlingName,
		...
		boolean f = dao.insertNewUser(gender, height, weight, role.getRoleId(), handling.getHandlingId(), userName,
				imageUrl);// 执行插入动作，并返回是否插入成功
		if (f) {
