...
<body>
	...
	<div class="content">
		<div >请选择遇到的问题</div>
            ...
            <input type="radio" name="error" class="error"  > <div>无登录记录</div></input>
			<input type="radio" name="error" class="error"> <div>手机收不到验证码</div></input>
			<input type="radio" name="error" class="error">  <div> 其他注册或问题</div></input>

    </div>
    
    <div class="content1">
    	<textarea name="errorMain" id="" class="errorMain" placeholder="请简要说明">
                </textarea>
