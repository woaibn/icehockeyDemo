...
<html>
	...
	<body>
		<div data-role="page" class="main">
			...
			<div class="renyuanxuanze">
				人员选择
			</div>
			<div class="renyuan">
				<div class="renyuan1" onclick="renyuan1Click()">
				
				</div>
				<div class="renyuan2" onclick="renyuan2Click()">

				</div>
				<div class="renyuan3" onclick="renyuan3Click()">

				</div>
				<div class="renyuan4" onclick="renyuan4Click()">

				</div>
				<div class="renyuan5" onclick="renyuan5Click()">
