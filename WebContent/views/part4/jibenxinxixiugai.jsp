...
<body>
				...
				<!--上传用户头像-->
					...
					<form action="" >
						...
						<div class="change_image">
							...
							<div class="uploadImg"> 
								<input type="file" data-role="none" accept="image/png" name="touxiang"
								class="touxiang" id="touxiang" /> 
						...
						<div class="content_div">
								...
								<div class="content_div_right">
									<select  data-role='none' placeholder="" id="clubName" class="select_div" />
										<c:choose>
						...
						<!--身高-->
							...
							<div class="content_div">
								...
								<div class="content_div_right">
									<input type="text" name="height" class="height" id="height" data-role='none'  />
								</div>
							</div>
						...
						<!--体重-->	
							<div class="content_div">
								...
								<div class="content_div_right">
									<input type="text" name="weight" class="weight" id="weight" data-role='none'  />
								</div>
							</div>
						...
						<!--位置-->	
							<div class="content_div">
								...
								<div class="content_div_right">
									<select  data-role='none' placeholder="" id="position" class="select_div"/>
										<c:choose>
    										<c:when test="${!empty positions}"}>
    											<c:forEach items="${positions}" var="position" varStatus="st">
													<option class="option" value='${position.positionId}'>${position.positionName}</option>
												</c:forEach>		
    										</c:when>
    									</c:choose>		
								    </select>
						...
						<!--角色-->	
							<div class="content_div">
								...
								<div class="content_div_right">
									<select  data-role='none' placeholder="" id="role"  class="select_div"/>
										<c:choose>
						...
						<!--持杆方式-->	
							<div class="content_div">
								...
								<div class="content_div_right">
									<select  data-role='none' placeholder="" id="handling" class="select_div" />
										<c:choose>
						...
						<!--<input type="text" name="name" class="name" id="name" data-role='none' placeholder="请输入真实姓名" />
		                <input type="text" name="idnum" class="idnum" id="idnum" data-role='none' placeholder="请输入身份证号" />-->
	...
	<script type="text/javascript" src="../../js/part4/jibenxinxixiugai.jss"></script>
</body>
</html>