		...
		<div data-role="page" class="tianbingtianjiangzhuyemian main">
			<div data-role="content">
				...
				<span class="uploadImg"  >
       				<input type="file" data-role="none" accept="image/png"  name="touxiang" class="touxiang" id="touxiang"/>
					<img src="../../img/part4/user-photo.png" class="image"/>
				</span>
				<!-- 上传用户昵称 -->
				<input type="text" name="name" class="name"  id="name" data-role='none'  placeholder="您的昵称" />
				
				<!--‘完成’按钮，点击触发事件-->
				<input type="button" value="完成" data-role='none' class="submitBtn" name="imgupload" id="imgupload"/>  
				</form>
				<form id="formimgupload" action="../../jsp/imageUpload.jsp" method="post" target="hidden_frame" enctype="multipart/form-data">
				</form> 
